				...
				<tr className="h-56">
					...
					<td className="border-2 border-gray-300 p-3">
						<a
							...
							target="_blank"
						>
							<img src={betterStackLogo.src} alt="Better Stack" width={260} height={224} />
						</a>
					</td>
					<td className="border-2 border-gray-300 p-3">
						<a href="https://nextlessjs.com">
							<img src={nextlessLogo.src} alt="React SaaS Boilerplate Next.js" width={260} height={224} />
						</a>
					</td>
				</tr>
				<tr className="h-56">
					...
					<td className="border-2 border-gray-300 p-3">
						<a href="https://turso.tech/?utm_source=nextjsstarterbp" target="_blank">
							<img src={tursoLogo.src} alt="SQLite Developer Experience" width={260} height={224} />
						</a>
					</td>
					<td className="border-2 border-gray-300 p-3">
						<a href="https://l.crowdin.com/next-js" target="_blank">
							<img src={crowdinLogo.src} alt="Crowdin" width={260} height={224} />
						</a>
					</td>
				</tr>
			</tbody>
